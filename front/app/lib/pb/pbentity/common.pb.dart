...
class Session extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Session', package: const $pb.PackageName(_omitMessageNames ? '' : 'pbentity'), createEmptyInstance: create)
    ...
    ..aOB(4, _omitFieldNames ? '' : 'UseStream', protoName: 'UseStream')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.bool get useStream => $_getBF(3);
  @$pb.TagNumber(4)
  set useStream($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasUseStream() => $_has(3);
  @$pb.TagNumber(4)
  void clearUseStream() => clearField(4);
}
